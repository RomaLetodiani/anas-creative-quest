            ...
            >
              <div className="space-y-4">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <motion.button
                    onClick={handleShare}
                    className="relative inline-flex items-center gap-3 glass-strong px-3 py-2 rounded-full text-gray-700 dark:text-gray-200 hover:scale-105 transition-transform duration-200 font-medium"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                ...
                <motion.p className="text-gray-600 glass-strong rounded-lg p-2 dark:text-gray-400 text-sm max-h-[10vh] md:max-h-[20vh] overflow-y-auto">
